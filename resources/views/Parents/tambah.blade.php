    ...
    <form action="simpanparent" method="post">
        ...
        <div class="card border-0 shadow-sm rounded-3">
            <div class="card-body p-4">
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" id="parent_full_name" name="parent_full_name" class="form-control" placeholder="Contoh: Budi Santoso" required>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" id="job" name="job" class="form-control" placeholder="Contoh: Wiraswasta, PNS, dll." required>
                    </div>

                    <div class="col-md-6">
                        <label for="address" class="form-label fw-semibold">Alamat Lengkap <span class="text-danger">*</span></label>
                        <input type="text" id="address" name="address" class="form-control" placeholder="Contoh: Jl. Merdeka No. 10, Surabaya" required>
                    </div>
                </div>
            </div>
            <div class="card-footer bg-white text-end py-3 border-top">
                ...
                <button type="submit" class="btn btn-primary fw-semibold px-4"><i class="bi bi-save me-1"></i>Simpan Data</button>
            </div>
        </div>
    </form>
@endsection
