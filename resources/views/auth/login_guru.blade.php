            ...
            <div class="card auth-card shadow-lg">
                <div class="card-body p-4 pb-3">
                    ...
                    <form action="{{ route('login.perform') }}" method="POST" class="row g-2">
                        @csrf
                        <input type="hidden" name="role" value="guru_bk">

                        <div class="col-12">
                            <label for="email" class="fk-form-label">Alamat Email</label>
                            <div class="fk-input-icon-group">
                                <i class="bi bi-envelope"></i>
                                <input type="email" name="email" class="fk-form-control" id="email" value="{{ old('email') }}" required autofocus placeholder="nama@sekolah.sch.id">
                            </div>
                        </div>
